...
<head>
  ...
  <title>Pamilya Muna - Party List</title>
  ...
  <link href="{{asset('/assets/css/coming_soon.css')}}" rel="stylesheet">
...
<body>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Pamilya Muna - Party List</span></strong>. All Rights Reserved
      </div>
    </div>
  </footer><!-- End #footer -->
